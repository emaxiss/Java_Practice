...
class Pagination extends BaseTest
{
	...
	void test()
	{
		...
		String results = driver.findElement(By.cssSelector("div#FilterItemView_all_summary > div > span:nth-of-type(1)")).getText();
		...
		System.out.println("Maximum results displayed on the page: " + resultsDisplayed);
